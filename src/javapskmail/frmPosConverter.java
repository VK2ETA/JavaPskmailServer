 ...
 * @author per
 */
public class frmPosConverter extends javax.swing.JDialog {
    boolean usedata=false;


/** Creates new form frmPosConverter */
    public frmPosConverter(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmPosConverter dialog = new frmPosConverter(new javax.swing.JFrame(), true);
